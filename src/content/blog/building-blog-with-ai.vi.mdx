...
Nếu bạn muốn viết nội dung kỹ thuật cho blog này sau khi dựng xong, bài [Cách Viết Blog Bằng Markdown Và MDX Trong Astro: quy trình xuất bản kỹ thuật](/vi/blog/markdown-guide) sẽ giúp phần xuất bản mượt hơn. Còn nếu bạn muốn nhìn AI ở quy mô lớn hơn một project cá nhân, hãy đọc [AI không thay nguyên xi một phòng ban: từ project cá nhân tới workflow doanh nghiệp](/vi/blog/ai-phong-ban-ao).
