...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_pC-QB3_s.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BS54py6g.mjs').then(n => n._);
...
const $$CategoryBadge = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<span${addAttribute(`inline-block px-3 py-1 text-xs font-semibold rounded-full ${categoryInfo.bgClass} backdrop-blur-sm`, "class")}> ${categoryInfo.name} </span>`;
}, "/Users/nguyenhuuloc/Documents/blog/src/components/CategoryBadge.astro", void 0);
...
export { $$CategoryBadge as $, getCollection as a, formatReadingTime as f, getReadingTime as g };
